...
```text
../screenshots/S3/01-s3-dashboard.png
```
...
```text
../screenshots/S3/02-create-bucket.png
```
...
```text
../screenshots/S3/03-versioning.png
```
...
```text
../screenshots/S3/04-encryption.png
```
...
```text
../screenshots/S3/05-folder-structure.png
```
